...
\begin{document}
  ...
  \begin{abstract}
    The O-series establishes the transfer chain $c_{\mathrm{BI}} \to \dpair \to \bstar$
  ...
  \section{Position of the Problem}
    ...
    Beau2026a25,Beau2026a26,Beau2026a27,Beau2026a28},
      ...
      The transfer chain $c_{\mathrm{BI}} \to \dpair \to \bstar$ was established unconditionally
  ...
  \section{Discussion}
    ...
    \subsection{Relation to O24}
      ...
      $c_{\mathrm{BI}} \to \dpair \to \bstar$ unconditionally with respect to the fibre structure
      of~$\Pi$; the O4--O6 growth-equation closure and coupling hypotheses, the Weil realisation,
      and the power-law regime remain its standing structural conditions.
